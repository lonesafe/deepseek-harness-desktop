...
The [macOS completion-wakeup repair](../bug-fix/2026-09-19-macos-office-import-wakeup.md) is a bounded application compatibility exception: Harness builds a separate helper from pinned kit source and publishes a private entry until a qualified kit release replaces both. Engine ownership, independent kit publication, and platform selection remain unchanged.
