...
The published browser bundle embeds the PDF.js and bundled-asset license texts. The [packed-artifact check](tests/pdf-license-bundle.e2e.ts) verifies their complete text after the repository build.
