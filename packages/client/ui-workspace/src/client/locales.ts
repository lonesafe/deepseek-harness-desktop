...
export const zh = {
  ...
  'files.tab': '文件',
  'files.title': '工作区文件',
  'files.emptyWorkspace': '当前会话不属于已注册工作区。',
  ...
  'files.root': '根目录',
  'files.preview': '文件预览',
  'files.markdownMode': 'Markdown 显示方式',
  'files.rendered': '预览',
  'files.source': '源码',
  'files.copy': '复制',
  'files.copied': '已复制',
  'files.footnotes': '脚注',
  'files.noSelection': '选择一个文件进行预览。',
  'files.unsupported': '此文件格式暂不支持预览，可以下载后打开。',
  'files.tooLarge': '文件超过 8 MiB 预览上限，请在设备本地打开。',
  'files.download': '下载文件',
  'files.truncated': '此文件夹项目过多，仅显示前 1000 项。',
  'files.error': '无法加载工作区文件：{message}',
  'files.fileFallback': '文件',
  'files.size.bytes': '{value} B',
  'files.size.kib': '{value} KiB',
  'files.size.mib': '{value} MiB',
...
export const en = {
  ...
  'files.emptyWorkspace': 'This session is not part of a registered workspace.',
  'files.loading': 'Loading files…',
  'files.empty': 'This folder is empty.',
  'files.showHidden': 'Show hidden files',
  'files.hideHidden': 'Hide hidden files',
  'files.refresh': 'Refresh',
  'files.back': 'Back to file list',
  'files.root': 'Root',
  'files.preview': 'File preview',
  'files.markdownMode': 'Markdown view mode',
  'files.rendered': 'Preview',
  'files.source': 'Source',
  'files.copy': 'Copy',
  'files.copied': 'Copied',
  'files.footnotes': 'Footnotes',
  'files.noSelection': 'Select a file to preview it.',
  'files.unsupported': 'This file format cannot be previewed. Download it to open locally.',
  'files.tooLarge': 'This file exceeds the 8 MiB preview limit. Open it on the device instead.',
  'files.download': 'Download file',
  'files.truncated': 'This folder has too many items. Showing the first 1,000.',
  'files.error': 'Could not load workspace files: {message}',
  'files.fileFallback': 'FILE',
  'files.size.bytes': '{value} B',
  'files.size.kib': '{value} KiB',
  'files.size.mib': '{value} MiB',
