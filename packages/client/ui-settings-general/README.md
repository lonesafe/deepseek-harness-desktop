...
At phone widths, the settings title and actions stay above a horizontally scrollable section rail, while the active section owns the full panel width and scrolls inside the dialog. Desktop widths retain the two-column navigation and content layout.
