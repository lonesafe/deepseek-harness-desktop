...
| `event:approval/asked` | event | `3de4c78f5e8160145c72557799ff01437fcca26415f5f1203bac4aaf536bfb31` | [`event:approval/asked`](#persistence-type-eventapprovalasked) |
...
<a id="persistence-type-allowed-always"></a>
...
Sources: [`packages/interaction/user-approval/src/types.ts:45`](../packages/interaction/user-approval/src/types.ts)

| Property | Presence | Type |
|---|---|---|
| `alwaysAllowKey` | optional | `string` |
...
Sources: [`packages/interaction/user-approval/src/types.ts:58`](../packages/interaction/user-approval/src/types.ts)
...
Sources: [`packages/llm/llm/src/types.ts:407`](../packages/llm/llm/src/types.ts)
