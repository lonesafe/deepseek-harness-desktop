...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  WorkspaceFileEntry: 'workspace.md',
  WorkspaceFileListing: 'workspace.md',
  WorkspaceFilePreview: 'workspace.md',
  ...
  WorkspaceListFilesRequest: 'workspace.md',
  WorkspaceOrderValue: 'workspace.md',
  WorkspaceReadFileRequest: 'workspace.md',
