...
[macOS 完成唤醒修复](../bug-fix/2026-09-19-macos-office-import-wakeup.zh.md)是有限的应用兼容例外：Harness 从固定的 kit 源码构建独立 helper，并发布私有入口，直到经资格验证的 kit 版本替代两者。引擎归属、kit 独立发布和平台选择保持不变。
