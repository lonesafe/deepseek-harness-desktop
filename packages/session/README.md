...
| [`session-format-v2-to-v3/`](session-format-v2-to-v3/README.md) | Frozen V2 decoding and migration to canonical V3 event envelopes | library — no ctx key |
| [`session-format-v3-to-v4/`](session-format-v3-to-v4/README.md) | V3 restoration and V4 migration preserving recorded approval decisions | library — no ctx key |
