...
export const remoteDefaultResponses: RemoteTable = {
  unary: {
    ...
    // ui-settings-general account balance at apply and on `connection/reset`.
    'llm/accountBalance': ok({ isAvailable: true, balances: [] }),
    ...
    'agentPresets/list': ok({ presets: [], authorable: false, modeSelectionEnabled: true }),
