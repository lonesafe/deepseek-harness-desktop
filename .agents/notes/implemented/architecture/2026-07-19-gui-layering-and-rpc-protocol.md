...
| Application | `@deepseek-ai/dsh` (apps/cli) + `dsh-web-frontend` (apps/web) + `dsh-desktop` (apps/desktop) | Coarse bin dispatch + Web frontend + Electron lifecycle and packaging | Applications do not alter Host assembly; workspace knowledge like dist and executable location stays in the app |
