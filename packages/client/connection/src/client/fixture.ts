...
function createFixtureWorld(options: FixtureOptions): FixtureWorld {
  ...
  const rpc: ClientConnectionRpc = {
    call(channel, endpoint, payload) {
      ...
      switch (endpoint) {
        // The built fixture mounts the dynamic Cordis client packages even
        // though it carries no dynamic definitions. Their boot-time mirror and
        // inventory reads therefore settle as an empty Host, not as transport
        // failures that pollute otherwise successful browser smoke tests.
