...
The [`weighted-approval` workflow](../workflows/weighted-approval.yml) publishes an approval score for branch rules in `deepseek-ai/deepseek-harness`. Both approval workflows skip their jobs in forks. Reviewer selection and review requests remain manual.
