...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('workspace-file-invalid-path'), message: z.string(), details: z.object({ workspaceId: z.string(), path: z.string() }) }),
  z.object({ code: z.literal('workspace-file-unreadable'), message: z.string(), details: z.object({ workspaceId: z.string(), path: z.string() }) }),
  z.object({ code: z.literal('workspace-file-not-file'), message: z.string(), details: z.object({ workspaceId: z.string(), path: z.string() }) }),
  ...
  z.object({ code: z.literal('balance-unavailable'), message: z.string(), details: z.object({ provider: z.string() }) }),
